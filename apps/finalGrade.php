...
<head>
     <!-- Scripts for the boot strap to work and images and links for style sheets in the head of the file -->
    <title>Final Grade</title>
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <link rel="stylesheet" style="text/css" href="styles/finalGrade.css">
    ...
    <style>
        /* Declares variables for the css in the file */
        :root {
        ...
        /* Padding for the table in the price cards */
        th,
        td {
            padding: 10px;
        }
        ...
        /* Content of the tab moved to algin with the center */
        .tab-content {
            margin: 20px;
        }
        ...
        /* Makes text area aligned with tabs */
        .textarea {
            display: block;
            width: 700px;
            overflow: hidden;
        ...
        /* code for the screen to be resized */
        ...
        /* Making sure the media screen is responsive to all devices */
...
<body>
     <!-- Allows GTA to view messages in the NavBar -->
    <?php
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="finalGrade.php">
                                Grade Final
                            </a>
                        </li>
                        <div class="nav-item">
    ...
    <br><br><br>
     <!-- Final Grade being shown in the center of the page, and which group is being graded -->
    <center>
        <h1>Final Grade</h1>
    </center>
    <br>
    ...
    <ul class="nav nav-tabs" id="groupTab" role="tablist">
     ...
     <!-- For the tabs in the final grade, to grade the final grade.-->
            ...
            <div class="tab-pane fade show <?php if ($countTab == 1) {
                ...
                <div class="tab-content" id="studentTabContent">
                    ...
                    foreach ($arrayforstudents as $key => $value1) {
                        ...
                        $cntMyTab++; ?>
                         <!-- The course and group appearing in the tabs. -->
                        <div class="tab-pane fade "
                            ...
                            tabindex="0"><?php
                            $countTab2++; ?>
                             <!-- Button for submit grade -->
                            <button id="updateBTN" type="submit"
                                form="addfinalgroup<?php echo $value1['groupid']; ?>student<?php echo $value1['studentid']; ?>"
                                name="finalGrade" class="btn updatebtn float right"> Submit Grade</button>
                            <br><br>
                             <!-- Displays the Final grade title and notes -->
                            <form action="addAssignmentGrade.php"
                                id="addfinalgroup<?php echo $value1['groupid']; ?>student<?php echo $value1['studentid']; ?>"
                                method="POST">
                                <table>
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><select name="<?php echo $value1['studentid']; ?>grade"
                                                 ...
                                                 <!-- Displays the notes area for the section -->
                                    ...
                                    <div class="row" style="display:flex; justify-content: space-around;">
                                        ...
                                        if ($studentsGrade != NULL) {
                                            foreach ($studentsGrade as $key => $value) {
                                                //Displaying the assignments for each student
                                                if ($value['assignment'] == "Development Plan" || $value['assignment'] == "Software Requirement Specification" || $value['assignment'] == "Design Plan" || $value['assignment'] == "Test Plan") { ?>
                                                    <div class="col-md-6" style="margin-top:10px;">
                                                     ...
                                                     <!-- Price of the table starts -->
                                                      <!-- To display the prototype past grades in the pricing tables -->
    ...
    <script>
        //Ajax to store the information on screen
